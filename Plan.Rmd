...
15th; Write up about ppmr.

week 1; Create plots of prey size and predator size with scharf regression lines (useful to be able to see/predict max/min/average sizes of prey eaten by certain sizes of predators).
