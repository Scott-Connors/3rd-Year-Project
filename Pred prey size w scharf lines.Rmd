...
require(gridExtra)
library(quantreg)
+ scale_x_continuous( expand = c(0,0), limits = c(50,85)) + scale_y_continuous( expand = c(0,0), limits = c(0,200))
...
#REDO NUMBERS HERE WITH NEW DATA AND UPDATE OVERLEAF WITH NEW EQUATIONS!!!!!!
