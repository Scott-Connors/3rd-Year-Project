...
```{r}
ggplot(data = acodlogppmr.example, aes(PPMR)) + geom_histogram(binwidth = 10000) + labs(title = "Atlantic Cod PPMR")
ggplot(data = ytunalogppmr.example, aes(PPMR)) + geom_histogram(binwidth = 7500) + labs(title = "Yellowfin Tuna PPMR")
ggplot(data = albacorelogppmr.example, aes(PPMR)) + geom_histogram(binwidth = 1000) + labs(title = "Albacore PPMR")
ggplot(data = dogfishlogppmr.example, aes(PPMR)) + geom_histogram(binwidth = 5000) + labs(title = "Spiny Dogfish PPMR")
```
...
```{r}
ggplot(data = acodlogppmr.example, aes(LogPPMR)) + geom_histogram(binwidth = 0.1) + labs(title = "Atlantic Cod log(PPMR)")
ggplot(data = ytunalogppmr.example, aes(LogPPMR)) + geom_histogram(binwidth = 0.1) + labs(title = "Yellowfin Tuna log(PPMR)")
ggplot(data = albacorelogppmr.example, aes(LogPPMR)) + geom_histogram(binwidth = 0.08) + labs(title = "Albacore log(PPMR)")
ggplot(data = dogfishlogppmr.example, aes(LogPPMR)) + geom_histogram(binwidth = 0.09) + labs(title = "Spiny Dogfish log(PPMR)")
```
